...
#define ChartColors_upColor   [UIColor colorWithHexString:@"#FC303A"] //红色
#define ChartColors_dnColor   [UIColor colorWithHexString:@"#35C051"] //绿色
#define ChartColors_max_upColor   [UIColor colorWithHexString:@"#FFFFFF"] //涨幅大于等于0.09
#define ChartColors_min_dnColor   [UIColor colorWithHexString:@"#6C006C"] //涨幅小于等于-0.09
#define ChartColors_mmdw_upColor   [UIColor colorWithHexString:@"#FC00FE"] //紫色
#define ChartColors_mmdw_dnColor   [UIColor colorWithHexString:@"#21FFFE"] //浅蓝色
...
//中枢颜色
#define rectColors_up_min_bgColor  [UIColor colorWithHexString:@"#145D33"] //(20,93,51)
#define rectColors_up_max_bgColor  [UIColor colorWithHexString:@"#95FF28"] //(149,255,40)
#define rectColors_down_min_bgColor  [UIColor colorWithHexString:@"#7C141E"]  //(124,20,30)
#define rectColors_down_max_bgColor  [UIColor colorWithHexString:@"#7B1482"] //(123,20,130)

#define rangesColors_up_min_bgColor  [UIColor colorWithHexString:@"#00B050"] //(0,176,80)
#define rangesColors_up_max_bgColor  [UIColor colorWithHexString:@"#A2FF34"] //(162,255,52)
#define rangesColors_down_min_bgColor  [UIColor colorWithHexString:@"#FE1818"] //(254,24,24)
#define rangesColors_down_max_bgColor  [UIColor colorWithHexString:@"#FE2CF4"] //(254,44,244)
...
static CGFloat ChartStyle_pointWidth = 11.0;
    ...
    //蜡烛之间的间距
static CGFloat ChartStyle_canldeMargin = 0.5;
...
static CGFloat ChartStyle_candleLineWidth = 1.5;
    ...
    //扩展中枢内边距
static CGFloat ChartStyle_pivotPadding = 3;
...
static CGFloat ChartStyle_gridColumns = 4;

static CGFloat TimeStyle_gridColumns = 2;

static CGFloat ChartStyle_topPadding = 10; //主图顶部预留空隙
   
static CGFloat ChartStyle_bottomDateHigh = 20.0;
   
static CGFloat ChartStyle_childPadding = 25.0;

static CGFloat ChartStyle_defaultTextSize = 14;
   
static CGFloat ChartStyle_bottomDatefontSize = 9;
   
   //表格右边文字价格
static CGFloat ChartStyle_reightTextSize = 10;

   //分时图固定时间区间
static CGFloat ChartStyle_timeSection = 390;

   //实时买卖视图宽度
static CGFloat ChartStyle_buySaleViewWidth = 130;
