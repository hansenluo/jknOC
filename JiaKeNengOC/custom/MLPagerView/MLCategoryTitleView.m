...
#import "MLCategoryTitleView.h"
#import "JXCategoryFactory.h"

@implementation MLCategoryTitleView
- (void)initializeData {
...
- (void)refreshCellModel:(JXCategoryBaseCellModel *)cellModel index:(NSInteger)index {
    ...
    if (self.titleColors.count > 0) {
        model.titleNormalColor = self.titleColors[index];
    }
    if (self.titleSelectedColors.count > 0) {
        model.titleSelectedColor = self.titleSelectedColors[index];
    }
